...
#Part 3
    with open("Credits outputs.txt", "w") as text_file:
        text_file.write("Part 3: \n")
        for item in Progress_list:
            text_file.write(f"Progress - {', '.join(str(i) for i in item)}\n")

        for item in Trailer_list:
            text_file.write(f"Trailer - {', '.join(str(i) for i in item)}\n")

        for item in Retriever_list:
            text_file.write(f"Retriever - {', '.join(str(i) for i in item)}\n")

        for item in Excluded_list:
            text_file.write(f"Excluded - {', '.join(str(i) for i in item)}\n")
